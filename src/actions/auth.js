...
const storeAuthInfo = (authToken, dispatch) => {
    ...
    dispatch(getUserInfo(authToken, decodedToken.user.id))
    saveAuthToken(authToken);
};

export const getUserInfo = (authToken, id) => dispatch => {
    ...
    .then(res => {
        if (res !== 'User Not Found') {
            ...
            console.log(`Could not find information for user with id of: ${id}`)
        }
    })
